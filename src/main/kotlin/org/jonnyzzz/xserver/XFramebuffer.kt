...
internal class XFramebuffer(
    ...
    companion object {
        ...
        private fun textPixel(text: String, column: Int, row: Int): Boolean {
            ...
            val glyph = textGlyph(text[charIndex]) ?: return false
            val glyphRow = row - 3
            if (cellX !in 1..5 || glyphRow !in glyph.indices) return false
            return ((glyph[glyphRow] ushr (5 - cellX)) and 1) != 0
        }

        private fun textGlyph(char: Char): IntArray? =
            lowercaseTextGlyph(char) ?: when (char.uppercaseChar()) {
                '0' -> glyph("11111", "10001", "10011", "10101", "11001", "10001", "11111")
                '1' -> glyph("00100", "01100", "00100", "00100", "00100", "00100", "01110")
                '2' -> glyph("11110", "00001", "00001", "11110", "10000", "10000", "11111")
                ...
                '6' -> glyph("01111", "10000", "10000", "11110", "10001", "10001", "01110")
                '7' -> glyph("11111", "00001", "00010", "00100", "01000", "01000", "01000")
                '8' -> glyph("01110", "10001", "10001", "01110", "10001", "10001", "01110")
                '9' -> glyph("01110", "10001", "10001", "01111", "00001", "00001", "11110")
                ...
                '/' -> glyph("00001", "00001", "00010", "00100", "01000", "10000", "10000")
                '=' -> glyph("00000", "00000", "11111", "00000", "11111", "00000", "00000")
                '.' -> glyph("00000", "00000", "00000", "00000", "00000", "01100", "01100")
                ',' -> glyph("00000", "00000", "00000", "00000", "00000", "01100", "01000")
                ':' -> glyph("00000", "01100", "01100", "00000", "01100", "01100", "00000")
                ';' -> glyph("00000", "01100", "01100", "00000", "01100", "01000", "10000")
                ...
                else -> glyph("01110", "10001", "00001", "00010", "00100", "00000", "00100").takeIf { char.code in 33..126 }
            }

        private fun lowercaseTextGlyph(char: Char): IntArray? =
            when (char) {
                ...
                'q' -> glyph("00000", "00000", "01111", "10001", "01111", "00001", "00001")
        ...
        private fun glyph(vararg rows: String): IntArray =
            IntArray(rows.size) { index ->
                rows[index].fold(0) { value, bit -> (value shl 1) or if (bit == '1') 1 else 0 }
            }
    }
}
