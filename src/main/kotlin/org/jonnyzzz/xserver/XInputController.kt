...
internal interface XEventSink {
    ...
    fun sendXkbMapNotifyEvent(event: XXkbMapNotifyEvent)
...
internal data class XXkbMapNotifyEvent(
    val timestamp: Int,
    val changed: Int,
    val minKeycode: Int,
    val maxKeycode: Int,
...
internal data class XXkbIndicatorStateNotifyEvent(
    val timestamp: Int,
    val state: Int,
    val changed: Int,
)

internal data class XXkbIndicatorStateNotifyDispatch(
    val sink: XEventSink,
    val event: XXkbIndicatorStateNotifyEvent,
)

internal data class XXkbIndicatorMapNotifyEvent(
    val timestamp: Int,
    val state: Int,
    val changed: Int,
)
...
internal data class XXkbNamesNotifyEvent(
    val timestamp: Int,
    val changed: Int,
    val firstType: Int,
    val nTypes: Int,
...
internal data class XXkbNamesNotifyDispatch(
    val sink: XEventSink,
    val event: XXkbNamesNotifyEvent,
)
