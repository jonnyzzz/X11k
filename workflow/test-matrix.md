...
| AWT/Swing Java2D samples | Java GUI behavior, overlapping windows, owned popups, and primitive SVG framebuffer export parity | Passing Docker/Xvfb parity probe |
