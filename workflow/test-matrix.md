...
The parity probe writes PNG/SVG/text diagnostics, visual diffs/metrics, visual region metrics, and IntelliJ client logs under `build/tmp/intellij-community-smoke/` so visual drift can be inspected without rerunning the heavyweight clients immediately.
