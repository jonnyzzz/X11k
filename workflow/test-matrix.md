...
| VSCode stable tarball | Real-world Electron target, heavyweight opt-in startup/rendering smoke and bounded full-pixel Xvfb parity with extension-query evidence | Passing opt-in smoke; bounded full-pixel parity opt-in |
